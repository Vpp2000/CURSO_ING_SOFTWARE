...
to setup
  ...
  set-default-shape trucks "ambulance"

  draw-road

  set lanes-truck lanes
...
to go
  ...
  ask trucks [ move-forward ]
  ask cars[
      let my-ycor ycor-of-selected-turtle
      let my-xcor xcor-of-selected-turtle
      let temp-myself self
    ;; ask one-of trucks [show ycor
    ;;show my-ycor show temp-myself]
    set some-ambul trucks with [xcor < my-xcor and ycor = my-ycor and ([distance temp-myself] of self) < 2.5]
    ;; set some-ambul trucks with [xcor < my-xcor and ycor = my-ycor]
    ;show some-ambul
    ;show some-ambul != nobody

    if count some-ambul != 0 [set patience 0]
  ]
...
to select-truck
  ...
  if mouse-down? [
    ...
    if any? trucks-on patch mx my [
      ...
      ask selected-truck [ set color yellow ]
      display
    ]
  ]
end
...
to-report ycor-of-selected-turtle
  report [ycor] of self
end

to-report xcor-of-selected-turtle
  report [xcor] of self
end
